...
<template>
  <div class="supervision flex-column">
    <YfDetailsHeader :path="formRoute" isQuery title="督办单详情" print @handlePrint="handlePrint"></YfDetailsHeader>
    ...
    <el-backtop target=".scrollWrap" :visibility-height="50" :right="20" :bottom="40"></el-backtop>
  </div>
</template>
...
export default {
  components: { baseForm, timelineForm, stopForm, processingForm, errorInfoTable, errorDealwith, partsReplacementForm,resultForm, history },
  data(){
    return {
...
.statusWrap{
  ...
  .status{
    height: 30px;min-width: 80px;border-radius: 3px;line-height: 30px;text-align: center;padding: 0 10px;
  }
}
</style>