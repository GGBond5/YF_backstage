<template>
  <div class="earlyWarning">
    <el-tabs v-model="activeName" v-if="!isDetails">
    ...
    <DetailsScheme2 v-if="isDetails" @back="isDetails = false"></DetailsScheme2>
  </div>
</template>

<script>
import TabularData from '@/views/operatingIndex/tabularData/TabularData.vue'
import DetailsScheme2 from '../../views/operatingIndex/details/DetailsScheme2.vue'
export default {
  data () {
    return {
