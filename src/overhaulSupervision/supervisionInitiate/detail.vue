...
<template>
  <div class="supervision flex-column">
    <YfDetailsHeader :path="formRoute" isQuery title="指派检修人" print @handlePrint="handlePrint"></YfDetailsHeader>
    ...
    <div class="flex-1 content flex-column">
      ...
      <div class="flex-1 scrollWrap" style="overflow: auto;" v-loading="loading" element-loading-background="rgba(0, 0, 0, 0)">
        ...
        <!-- <YfCollapse title="联动处理督办单"  style="padding: 5px 15px 0 7px;" ref="collapse5" key="5" v-if="activeName=='#/step_2'">
          <linkageForm :prosessCode="4"></linkageForm>
        </YfCollapse> -->
        ...
        this.$refs.baseForm.$refs.form1.validate((valid) => {
          if (valid) {
            ...
            let data = {
              ...
              "supervisorDeptId": _formData.supervisorDeptId,
              "supervisorId": _formData.supervisorId
            }
            this.loading = true
